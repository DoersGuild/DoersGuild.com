...
var portfolioItems = map[string]PortfolioItem {
    ...
    "iEntertain" : {
        ...
        []string{"/img/projects/iEntertain/mobile1.png", "/img/projects/iEntertain/tablet1.png"},
	...
	"ProGrade" : {
        ...
        []string{"/img/projects/ProGrade/mobile1.png", "/img/projects/ProGrade/tablet1.png"},
        []string{"PhoneGap","Android", "jQuery Mobile"},
        portfolioClients["DoersGuild"],
        []Feedback{},
    },
	 "MindOverMedia" : {
        ...
        []string{"/img/projects/MindOverMedia/desktop1.jpg","/img/projects/MindOverMedia/mobile1.jpg"},
        []string{"PhoneGap","Android", "jQuery Mobile"},
	...
	"CodePad": {
        ...
        "/img/projects/CodePad/tablet1.png",
        []string{"/img/projects/CodePad/desktop1.png","/img/projects/CodePad/tablet1.png"},
        []string{"PHP", "GAE", "MobWrite", "CodeMirror"},
        portfolioClients["DoersGuild"],
        []Feedback{},
    },
	"FreeWorkExchange": {
        ...
        "/img/projects/FreeWorkExchange/tablet1.png",
        []string{"/img/projects/FreeWorkExchange/desktop1.png","/img/projects/FreeWorkExchange/tablet1.png"},
	...
	"Xervmon": {
        ...
        "September, 2012",
        "WebApps",
        map[string]string{"Xervmon" : "http://freeworkexchange.appspot.com"},
        "/img/projects/Xervmon/logo.png",
        []string{"/img/projects/Xervmon/desktop1.png","/img/projects/Xervmon/tablet1.png"},
        []string{"HTML5", "CSS3", "jQuery", "NVD3", "Twitter Bootstrap framework"},
        portfolioClients["DoersGuild"],
        []Feedback{},
    },
	"Tharunopayam": {
        ...
        "September, 2013",
        "WebApps",
        map[string]string{"Tharunopayam" : "http://freeworkexchange.appspot.com"},
        "/img/projects/Tharunopayam/logo.png",
        []string{"/img/projects/Tharunopayam/desktop1.png","/img/projects/Tharunopayam/tablet1.png"},
        []string{"HTML5", "CSS3", "jQuery", "NVD3", "Twitter Bootstrap framework"},
        portfolioClients["DoersGuild"],
        []Feedback{},
    },
	...
	"Tharuni": {
        ...
        "september, 2012",
        "Websites",
        map[string]string{"Live Site":"http://start.tharuni.org/"},
        "/img/projects/Tharuni/desktop1.png",
        []string{"/img/projects/Tharuni/desktop1.png"},
        []string{"HTML5", "CSS3", "jQuery", "Twitter Bootstrap"},
        portfolioClients["Rebel316"],
        []Feedback{},
    },
	"tasheelatiraq": {
        ...
        "/img/projects/tasheelatiraq/desktop1.png",
        []string{"/img/projects/tasheelatiraq/desktop1.png"},
...
var portfolioCategories = map[string]Category {
	...
	"Plugins" : Category {
        ...
        "Want to empower your users with a cool plugin? Need jQuery or WordPress Plugins to enhance your site performance? We can do it for you!",
    },
}
